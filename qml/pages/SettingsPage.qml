...
Page {
    ...
    // Mesaj de stare pentru testul imprimantei (setat din printerManager.testResult).
    ...
    // Primește rezultatul testului de conexiune la imprimantă.
    Connections {
    ...
    Flickable {
        ...
        ColumnLayout {
            ...
            ColumnLayout {
                ...
                // Buton separat: trimite un bon ZPL real la imprimantă (nu doar
                // testează soclul TCP, ca butonul de mai sus).
                Rectangle {
                    Layout.fillWidth: true
                    Layout.preferredHeight: 48
                    radius: 14
                ...
                // Mesaj de stare (rezultat test / selecție).
                Label {
                    Layout.fillWidth: true
    ...
    // Dialogul de căutare imprimante.
