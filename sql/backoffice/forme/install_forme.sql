...
begin
  ...
  adp(v_chel, q'[XSQL]', q'[XSQL]', null, c_grp, q'[M]', null, null, null, q'[select cod_univ, oficiant, clcoficiantt, pin, active, can_edit_tables from vuw_waiters_all where cod_univ = :cod_univ order by oficiant]', null, null, q'[select cod_univ, oficiant, clcoficiantt, pin, active, can_edit_tables from vuw_waiters_all where cod_univ = :cod_univ order by oficiant]', null);
  ...
  adp(v_chel, q'[XSQL_INSERT]', q'[XSQL_Insert]', null, c_grp, q'[M]', null, null, null, q'[insert into vuw_waiters_all (cod_univ, oficiant, pin, active, can_edit_tables) values (:cod_univ, :oficiant, :pin, :active, :can_edit_tables)]', null, null, q'[insert into vuw_waiters_all (cod_univ, oficiant, pin, active, can_edit_tables) values (:cod_univ, :oficiant, :pin, :active, :can_edit_tables)]', null);
  adp(v_chel, q'[XSQL_REFRESH]', q'[XSQL_Refresh]', null, c_grp, q'[M]', null, null, null, q'[select cod_univ, oficiant, clcoficiantt, pin, active, can_edit_tables from vuw_waiters_all where cod_univ = :cod_univ and oficiant = :oficiant]', null, null, q'[select cod_univ, oficiant, clcoficiantt, pin, active, can_edit_tables from vuw_waiters_all where cod_univ = :cod_univ and oficiant = :oficiant]', null);
  adp(v_chel, q'[XSQL_UPDATE]', q'[XSQL_Update]', null, c_grp, q'[M]', null, null, null, q'[update vuw_waiters_all set pin = :pin, active = :active, can_edit_tables = :can_edit_tables where cod_univ = :cod_univ and oficiant = :oficiant]', null, null, q'[update vuw_waiters_all set pin = :pin, active = :active, can_edit_tables = :can_edit_tables where cod_univ = :cod_univ and oficiant = :oficiant]', null);
